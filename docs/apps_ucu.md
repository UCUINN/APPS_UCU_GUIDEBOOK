...
<div style="text-align: center; margin: 2rem 0;">
  <img src="assets/logo/logo_aps_eng.svg" alt="APPS UCU Logo" style="max-width: 400px; width: 100%;">
</div>
...
## Чому обрати Факультет прикладних наук?
...
<div style="background: #ffffff; padding: 2rem; border-radius: 12px; text-align: center; border: 1px solid #e5e7eb;">
  <img src="assets/logo/logo_aps_eng.svg" alt="APPS Logo Light" style="max-width: 200px;">
...
<div style="background: #1a1a2e; padding: 2rem; border-radius: 12px; text-align: center;">
  <img src="assets/logo/logo_aps_eng_full_color.svg" alt="APPS Logo Full Color" style="max-width: 200px;">
